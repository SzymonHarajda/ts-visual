...
export default function Contact() {
  ...
  const x_mobile = useTransform(scrollYProgress, [0, 1], [0, 20]);
  const y = useTransform(scrollYProgress, [0, 1], [-500, 0]);

  const rotate = useTransform(scrollYProgress, [0, 1], [120, 90]);
  return (
    <motion.div style={isDesktop ? {} : { y }} ref={container} className={styles.contact}>
      <div className={styles.body}>
          ...
          <Link href="/contact">
            <div data-scroll data-scroll-speed={0.1}>
              {isDesktop ? (
                ...
                <motion.div style={{ x: x_mobile }} className={styles.buttonContainer}>
                  <Rounded backgroundColor={"#535762"} className={styles.button}>
                    <p>Get in touch</p>
                  </Rounded>
                </motion.div>
        ...
        <div className={styles.info}>
          ...
          <div>
            ...
            <Magnetic>
              <p>
                <a href="https://www.instagram.com/tmvisual__/#">
                  Instagram
                </a>
              </p>
            </Magnetic>
